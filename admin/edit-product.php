...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $imageName = $product['img']; // keep old image by default
  ...
  if(isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
    ...
    if(!in_array($fileExt, $allowed)) {
      ...
      if($product['img'] && file_exists('../assets/img/' . $product['img'])) {
      ...
      if(!move_uploaded_file($_FILES['image']['tmp_name'], $uploadPath)) {
        ...
        $imageName = $product['img']; // revert to old image
      }
    }
  }
  
  if(empty($errors)) {
    if($crud->updateProduct($productId, $name, $categoryId, $price, $description, $imageName)) {
      $success = true;
...
<div class="admin-content">
    <div class="wrap">
        ...
        <?php if($success): ?>
            <div class="success-box">Product updated successfully!</div>
        <?php endif; ?>
        ...
        <form method="post" enctype="multipart/form-data" class="admin-form">
            ...
            <div class="form-group">
                ...
                <?php if($product['img']): ?>
                    <img src="../assets/img/<?php echo $product['img']; ?>" alt="Current" class="current-img">
                <?php else: ?>
                    <p>No image</p>
                <?php endif; ?>
            </div>
            ...
            <div class="form-actions">
                <button type="submit" class="cta-btn">Update Product</button>
